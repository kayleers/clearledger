...
Deno.serve(async (req) => {
  try {
    ...
    const filename = `Scenario_${scenario.name.replace(/[^a-zA-Z0-9]/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`;
