...
Deno.serve(async (req) => {
  try {
    ...
    const filename = `Account_${accountData.name.replace(/[^a-z0-9]/gi, '_')}_${new Date().toISOString().split('T')[0]}.pdf`;
